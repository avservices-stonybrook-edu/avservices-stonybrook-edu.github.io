/*!
 * PhotoSphereViewer.SettingsPlugin 5.7.4
...
var _SettingChangedEvent = class _SettingChangedEvent extends TypedEvent {
  /** @internal */
...
var SettingsPlugin = class extends AbstractPlugin {
  ...
  init() {
    super.init();
    utils3.checkStylesheet(this.viewer.container, "settings-plugin");
