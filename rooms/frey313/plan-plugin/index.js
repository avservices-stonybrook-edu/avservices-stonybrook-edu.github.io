(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('three'), require('leaflet'), require('@photo-sphere-viewer/core')) :
    typeof define === 'function' && define.amd ? define(['exports', 'three', 'leaflet', '@photo-sphere-viewer/core'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global.PhotoSphereViewer = global.PhotoSphereViewer || {}, global.PhotoSphereViewer.PlanPlugin = {}), global.THREE, global.L, global.PhotoSphereViewer));
})(this, (function (exports, THREE, L, PhotoSphereViewer) {
...
"use strict";
  ...
  var import_leaflet2 = require_leaflet();
  ...
  // src/utils.ts
  var import_leaflet = require_leaflet();
