(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('three'), require('@photo-sphere-viewer/core'), require('@photo-sphere-viewer/settings-plugin')) :
    typeof define === 'function' && define.amd ? define(['exports', 'three', '@photo-sphere-viewer/core', '@photo-sphere-viewer/settings-plugin'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global.PhotoSphereViewer = global.PhotoSphereViewer || {}, global.PhotoSphereViewer.ResolutionPlugin = {}), global.THREE, global.PhotoSphereViewer, global.PhotoSphereViewer.SettingsPlugin));
})(this, (function (exports, THREE, PhotoSphereViewer, SettingsPlugin) {
...
/*!
 * PhotoSphereViewer.ResolutionPlugin 5.7.4
...
"use strict";
  ...
  _ResolutionPlugin.VERSION = "5.7.4";
